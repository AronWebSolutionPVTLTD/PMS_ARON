...
const AddUser = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    userHTTPService.createUser2(data).then(data => {
      ...
      <form method="POST" className="" onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          ...
          <div className="form-group col-md-6">
            ...
            <select {...register('designation', { required: true })} onChange={handleInputChange}
              value={user.role} name="designation" className="form-control select2 select2-hidden-accessible"
          ...
          <div className="form-group col-md-6">
            ...
            <select {...register('department', { required: true })} onChange={handleInputChange}
              value={user.role} name="department" className="form-control select2 select2-hidden-accessible"
              tabindex="-1" aria-hidden="true">
